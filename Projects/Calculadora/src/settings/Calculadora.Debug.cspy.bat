...
"C:\Program Files\IAR Systems\Embedded Workbench 9.0\common\bin\cspybat" -f "D:\Pastas Locais\Documentos\IAR projetos\Exercícios\Projeto_Final\Projects\Calculadora\src\settings\Calculadora.Debug.general.xcl" --backend -f "D:\Pastas Locais\Documentos\IAR projetos\Exercícios\Projeto_Final\Projects\Calculadora\src\settings\Calculadora.Debug.driver.xcl" 
